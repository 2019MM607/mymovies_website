  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1  md:grid-cols-2 justify-items-center ">
        {cast?.map((item: Cast) => (
          <div
            className=" flex md:w-1/2 mb-10 w-[80%] md:mb-5 bg-gray-800 shadow-xl p-2 rounded-l-full justify-between "
            key={item?.id}
          >
            {item?.profile_path && (
              <>
                ...
                />
                <div className="">
                  <p className="text-white text-right font-semibold mb-2">
                    {item?.original_name}
                  </p>
